...
public final class Settings {
	...
	public static final String LATEST_UPDATE = "--Update 1--<br>"
			+ "Easter bunny has come to Runic! Don't forget to collect your eggs!<br>Osrs gameframe option has been added!<br>Jad Test Mode is now available!<br>Trivia has been updated!<br>Bug fixes & improvements!";

	public static final String SERVER_NAME = "Runic";
	...
	private static final String LIVE_IP = "127.0.0.1";//"144.217.11.36"; reenable if we do multiple worlds but gonna enable
	...
	public static String MASTER_PASSWORD = "123";//asdfasdfasfdsafsdf
	public static boolean MASTER_PASSWORD_ENABLED = true;
	...
	public static final WorldTile START_PLAYER_LOCATION = new WorldTile(2143, 3541, 0);
	...
	public static final double FAST_MODE_MULTIPLIER = 2, COMBAT_XP_RATE = 15, XP_RATE = 5, DROP_RATE = 1;
