				...
				public void run() {
					...
					if (target instanceof Player) {
						...
						if (player.getControlerManager().getControler() instanceof TheHorde) {
							TheHorde horde = (TheHorde) player.getControlerManager().getControler();
							npc.setNextWorldTile(horde.getWorldTile(2 + Utils.random(26), 2 + Utils.random(26)));
						}
					}
					if (npc.getNextWorldTile() == null)
