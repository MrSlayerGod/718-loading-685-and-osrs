...
public class SkeletalWyvernCombat extends CombatScript {
	...
	protected static boolean hasShield(Entity target) {
		...
		return shieldId == 2890 || shieldId == 9731 || shieldId == 20436 || shieldId == 20438 || shieldId == 18691 || (shieldId >= 11283 && shieldId <= 12285)
				|| (shieldId >= 52002 && shieldId <= 52004) || (shieldId >= 51633 && shieldId <= 51635) ;
	}
	...
	public int attack(NPC npc, Entity target) {
		...
		case 0:
			...
			delayHit(npc, 1, target, getRegularHit(npc, Utils.getRandom(hasShield(target) ? 50 : 600)));
			break;
		case 1:
