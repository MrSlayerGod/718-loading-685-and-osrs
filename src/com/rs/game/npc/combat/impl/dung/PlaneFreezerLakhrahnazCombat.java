		...
		if (Utils.random(3) == 0) {
			...
			case 0:
				...
				for (Entity t : npc.getPossibleTargets()) {
					...
					delayHit(npc, 1, t, getMagicHit(npc, getRandomMaxHit(npc, (int) (npc.getMaxHit() * 0.6), NPCCombatDefinitions.MAGE, target)));
				}
				break;
			case 1:
				...
				delayHit(npc, 0, target, getMeleeHit(npc, getRandomMaxHit(npc, (int) (npc.getMaxHit() * 0.75), NPCCombatDefinitions.MELEE, target)));
				break;
			}
