...
public class GravecreeperCombat extends CombatScript {
	...
	public int attack(NPC npc, Entity target) {
		...
		case 0://range
			...
			delayHit(npc, 1, target, getRangeHit(npc, getRandomMaxHit(npc, (int) (npc.getMaxHit() * 0.5), NPCCombatDefinitions.RANGE, target)));
			break;
		case 1://melee
			npc.setNextAnimation(new Animation(14503));
			delayHit(npc, 0, target, getMeleeHit(npc, getRandomMaxHit(npc, (int) (npc.getMaxHit() * 0.5), NPCCombatDefinitions.MELEE, target)));
			break;
		}
		return 4;
	}
