...
public class LexicusRunewrightCombat extends CombatScript {
	...
	public int attack(NPC npc, Entity target) {
		...
		case 3://Magic
			...
			if (range_style)
				delayHit(npc, 1, target, getRangeHit(npc, getRandomMaxHit(npc, (int) (npc.getMaxHit() * .95), NPCCombatDefinitions.RANGE, target)));
			else
		...
		case 4://MELEE
			...
			delayHit(npc, 0, target, getMeleeHit(npc, getRandomMaxHit(npc, (int) (npc.getMaxHit() * .75), NPCCombatDefinitions.MELEE, target)));
			break;
		}
		return 5;
	}
