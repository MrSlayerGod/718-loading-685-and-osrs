...
public class DungeonSlayerNPC extends DungeonNPC {
	...
	private static final WeaponType[][][] WEAKNESSES = {
		...
		{ { new WeaponType(Combat.MAGIC_TYPE, PlayerCombat.WATER_SPELL) }, { new WeaponType(Combat.MELEE_TYPE, CombatDefinitions.STAB_ATTACK) }, { new WeaponType(Combat.MELEE_TYPE, CombatDefinitions.SLASH_ATTACK) } },
