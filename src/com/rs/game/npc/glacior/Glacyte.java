...
public class Glacyte extends NPC {
	...
	public Glacyte(Glacor glacor, int id, WorldTile tile, int mapAreaNameHash, boolean canBeAttackFromOutOfArea, boolean spawned) {
		...
		explosionTicks = 25;
		targetIndex = -1;
		setForceMultiArea(true); //just in case
	}
