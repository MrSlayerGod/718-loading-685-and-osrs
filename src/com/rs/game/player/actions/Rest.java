...
public class Rest extends Action {
	...
	public boolean start(Player player) {
		...
		if (musician)
			player.getMusicsManager().playMusic(941);
	...
	public boolean process(Player player) {
		...
		if (player.getEquipment().getLegsId() >= 21000) {
			player.getPackets().sendGameMessage("You can't rest while wearing these trousers");
			return false;
		}
		return true;
	}
