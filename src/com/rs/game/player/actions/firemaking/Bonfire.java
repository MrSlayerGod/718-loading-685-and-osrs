...
public class Bonfire extends Action {
	...
	public static enum Log {
		...
		OAK(1521, 3099, 15, 88, 12),
		WILLOW(1519, 3101, 30, 109, 18),
		TEAK(6333, 3103, 35, 125, 24),
		MAPLE(1517, 3100, 45, 182, 36),
		MAHOGANY(6332, 3102, 50, 189, 42),
		EUCALYPTUS(12581, 3112, 58, 204, 48),
		YEWS(1515, 3111, 60, 270, 54),
		MAGIC(1513, 3135, 75, 320, 60),
		REDWOOD(49669, 3100, 90, 380, 60),
