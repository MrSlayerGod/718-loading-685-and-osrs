...
public final class EmotesManager implements Serializable {
	...
	public void useBookEmote(int id) {
		...
		if (id == 2) {// Yes
			...
			case 19709:
			case 19710: 
				nextEmoteEnd = Utils.currentTimeMillis() + (12 * 600);
				WorldTasksManager.schedule(new WorldTask() {
					int step;
					...
					public void run() {
						if (step == 1) {
							...
							/*dung1 = new NPC(-1, new WorldTile(player.getX(), player.getY() - 1, player.getPlane()), -1,
									true);*/
						...
						//	dung1.setLocation(dung1);
							...
							World.sendGraphics(player, new Graphics(2777), new WorldTile(player.getX(), player.getY() - 1, player.getPlane()));
							/*dung2 = new NPC(-1, new WorldTile(player.getX() + 1, player.getY() - 1, player.getPlane()),
									-1, true);*/
						}
						if (step == 2) {
							...
							World.sendGraphics(player, new Graphics(2778), new WorldTile(player.getX() + 1, player.getY() - 1, player.getPlane()));
						/*	dung3 = new NPC(-1, new WorldTile(player.getX(), player.getY() - 1, player.getPlane()), -1,
									true);
							dung4 = new NPC(-1, new WorldTile(player.getX(), player.getY() + 1, player.getPlane()), -1,
									true);*/
						}
						if (step == 3) {
							//dung2.finish();
						...
						//	dung4.setLocation(dung4);
							...
							World.sendGraphics(player, new Graphics(2779), new WorldTile(player.getX(), player.getY() - 1, player.getPlane()));
							World.sendGraphics(player, new Graphics(2780), new WorldTile(player.getX(), player.getY() + 1, player.getPlane()));
			...
			case 20767: // Max cape
				...
				int size = NPCConfig.forID(1224).boundSize;
