...
public abstract class Cutscene {
	...
	public final boolean process(Player player) {
		...
		if (stage != actions.length) 
			actions[stage].onCompletion(player, cache);
		while (true) {
	...
	public static void setCameraPos(Player player, WorldTile tile, int height) {
		player.getPackets().sendCameraPos(Cutscene.getX(player, tile.getX()), Cutscene.getY(player, tile.getY()), height);
	}
	
	public static void setCameraPos(Player player, WorldTile tile, int height, int speed1, int speed2) {
		player.getPackets().sendCameraPos(Cutscene.getX(player, tile.getX()), Cutscene.getY(player, tile.getY()), height, speed1, speed2);
	}
	
	
	public static void setCameraLook(Player player, WorldTile tile, int height) {
		player.getPackets().sendCameraLook(Cutscene.getX(player, tile.getX()), Cutscene.getY(player, tile.getY()), height);
	}
	
	public static void setCameraLook(Player player, WorldTile tile, int height, int speed1, int speed2) {
		player.getPackets().sendCameraLook(Cutscene.getX(player, tile.getX()), Cutscene.getY(player, tile.getY()), height, speed1, speed2);
	}
}
