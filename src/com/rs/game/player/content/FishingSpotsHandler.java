...
public class FishingSpotsHandler {
	...
	public static void init() {
		...
		moveSpots.put(new WorldTile(2846, 3429, 0).getTileHash(), new WorldTile(2854, 3423, 0).getTileHash());
		...
		moveSpots.put(new WorldTile(3288, 5267, 0).getTileHash(), new WorldTile(3284, 5271, 0).getTileHash());
		moveSpots.put(new WorldTile(2834, 3431, 0).getTileHash(), new WorldTile(2838, 3431, 0).getTileHash());
	}
