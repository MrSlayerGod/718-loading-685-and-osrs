...
public class TeamVsTeam implements SurpriseEvent {
	 ...
	 */
	public static final int REWARD_CASH_FINAL = 1500000;
	/**
	 * Spins for event winner.
	 */
	public static final int REWARD_SPINS_FINAL = 3;
	...
	private void timerinit() {
		...
		World.sendNews(null, "Team vs Team event will start in " + PREP_MINS + " minute! Type ::event to get there.", World.WORLD_NEWS);
	}
