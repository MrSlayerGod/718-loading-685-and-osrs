...
public class FlyingEntityHunter {
	...
	public enum FlyingEntities {
		...
		{ new Item(6328, 1) /*
			...
			new Item(1215, 1), new Item(6313, 1) /*
													...
													*/, new Item(892, 70), new Item(811, 70) /*
																								* Rune
																								* dart
																								*/, new Item(868, 40), new Item(1747, 16), new Item(140, 4), new Item(805, 40) }, new Item[]
		...
		CRYSTAL_IMPLING(28741, 53768, 370, 500, 80,new Item[]{new Item(1732, 5, 7), new Item(31702, 1), new Item(1616, 2), new Item(9191, 50, 125), new Item(9194, 6, 10), new Item(44, 167, 250), new Item(892, 421, 750), new Item(49580, 20, 60), new Item(824, 25, 75), new Item(811, 50, 100), new Item(11232, 10, 15), new Item(1216, 2), new Item(1334, 3, 7), new Item(535, 75, 125), new Item(5295, 3, 8), new Item(5315, 1), new Item(53943)}, null, null, null),
		...
		DRAGON_IMPLING(6054, 11256, 390, 553, 83, new Item[]
		{
				...
				, new Item(49484, 35)
				, new Item(49484, 25)},
		 new Item[] {new Item(1616, 3), new Item(4093), new Item(1705, 3), new Item(1684, 2), new Item(1216, 3) , new Item(11230, 300)}
		, new Item[]{new Item(7219, 15)}, null),
		...
		{ new Item(1631, 1), new Item(1615, 1), new Item(9341, 40 /*+ Utils.random(30)*/), new Item(9342, 57), new Item(15511, 1), new Item(15509, 1), new Item(15505, 1), new Item(15507, 1),
			new Item(15503, 1), new Item(11212, 100 + 104), new Item(9193, 100/*62 + Utils.random(8)*/), new Item(11230, 600), new Item(11230, 300),
			new Item(1306, Utils.random(1, 2)), new Item(1249, 1) }, new Item[]
		{ new Item(9194, 20/*Utils.random(1, 71)*/) }, new Item[]
	...
	public static void captureFlyingEntity(final Player player, final NPC npc) {
		...
		if (player.getSkills().getLevel(Skills.HUNTER) < instance.getLevel() + 10) {
			if (weaponId != 11259 && weaponId != 10010 && weaponId != 14110 && weaponId != 14102 && isImpling) {
		...
		player.lock(2);
		player.getPackets().sendGameMessage(weaponId == -1 ? "You move your hands..." : "You swing your net...");
		
		player.setNextAnimation(weaponId == -1 ? new Animation(834) : weaponId == 14110 || weaponId == 14102 ? new Animation(10622) : CAPTURE_ANIMATION);
