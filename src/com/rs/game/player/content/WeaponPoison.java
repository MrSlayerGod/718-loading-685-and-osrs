...
public class WeaponPoison {
	...
	public static enum Weapon {
		...
		//osrs
		ABYSSAL_DAGGER(43265, 43267, 43269, 43271),
		DRAGON_JAVELIN(49484, 49486, 49488, 49490),
		DRAGON_BOLTS(51905, 51924, 51926, 51928),
		DRAGON_HASTA(52731, 52734, 52737, 52740),
		DRAGON_KNIFE(52804, 52806, 52808, 52810),
		;
