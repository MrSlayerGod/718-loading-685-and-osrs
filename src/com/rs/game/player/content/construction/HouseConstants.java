...
public class HouseConstants {
	...
	public static enum Builds {
		...
		,
		CHAMBERS_STORAGE_UNIT(new int[] {129769}, false, HObject.SMALL_STORAGE_UNIT)
		,
		CHAMBERS_STORAGE_UNIT_SMALL(new int[] {129770}, false, HObject.MEDIUM_STORAGE_UNIT)
		,
		CHAMBERS_STORAGE_UNIT_MED(new int[] {129779}, false, HObject.LARGE_STORAGE_UNIT)
		;
	...
	public static enum HObject {
		// CHAMBERS OF XERIC
		SMALL_STORAGE_UNIT(51037, 129770, 30, 100, new Item(51036, 2)),
		MEDIUM_STORAGE_UNIT(51038, 129779, 60, 100, SMALL_STORAGE_UNIT, new Item(51036, 2)),
		LARGE_STORAGE_UNIT(51039, 129780, 90, 100, MEDIUM_STORAGE_UNIT, new Item(51036, 2)),
		...
		private HObject(int itemId, int id, int level, double xp, HObject upgrade, Item... reqs) {
			this(itemId, new int[]
					{ id }, level, xp, reqs);
	...
	public static enum POHLocation {
		...
		GREAT_KOUREND(new WorldTile(1742, 3517, 0), 25, 8750),
		...
		PRIFDDINAS(new WorldTile(2215, 3324, 0), 70, 50000),
