...
public class FairyRings {
	...
	public static enum Rings {
		...
		DIP(new WorldTile(3037, 4763, 0)),
		DIS(new WorldTile(3108, 3149, 0)),
		DJP(new WorldTile(2658, 3230, 0)),
		DJR(new WorldTile(1455, 3658, 0/*2676, 3587, 0*/)), //new WorldTile(1302, 3762, 0)),
		...
		BJS(new WorldTile(2150, 3070, 0)),
		AIS(null),
		AIP(null),
		AKP(null),
		CIS(new WorldTile(1639, 3868, 0)),
		CIR(new WorldTile(1302, 3762, 0)),
		;
	...
	public static boolean checkAll(Player player) {
		/*if (player.isDonator() || player.getEquipment().getWeaponId() == 772 || player.getEquipment().getWeaponId() == 9084)
			return true;
	...
	private static void sendTravelLog(Player player) {
		...
		player.getPackets().sendIComponentText(735, 48, "          Zeah: Mount Karuulm");
		player.getPackets().sendIComponentText(735, 49, "          Zeah: North of the Arceuus House Library"); //CIS
		player.getPackets().sendIComponentText(735, 52, "          Zeah: Chasm of Fire");/*"          Kandarin: Sinclair Mansion");*/
		...
		player.getPackets().sendIComponentText(735, 62, "          Abyssal Nexus"/*"          Mos Le'Harmless: Isle on the coast of Mos Le'Harmless"*/);
