...
public class ItemSets {
	...
	public enum Sets {
		AKRISAES(21768, 21736, 21744, 21752, 21760),
	...
	public static void openSkillPack(Player player, int packItem, int openedItem, int amountPerPack, int requestCount) {
		...
		player.getPackets().sendGameMessage("You open the spirit shard pack and receive " + totalAmount + " " + ItemConfig.forID(openedItem).getName().toLowerCase() + ".");
	}
}
