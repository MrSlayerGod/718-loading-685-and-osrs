...
public class RugMerchantD extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case 1:
			...
			case OPTION_3:
				stage = 16;
				sendNPCDialogue(2291, 9827, "<p=2>From here you can travel to Shantay Pass, Uzer, the Bedabin Camp or to<br>north Pollnivneach.");
				break;
			default:
				stage = -2;
		...
		case 18:
			switch (componentId) {
			case OPTION_1:
				Magic.sendTeleportSpell(player, 654, 331, 2931, 2933, 0, 0d, new WorldTile(3308, 3109, 0), 4, false, Magic.OBJECT_TELEPORT);
				break;
			case OPTION_2:
				Magic.sendTeleportSpell(player, 654, 331, 2931, 2933, 0, 0d, new WorldTile(3469, 3113, 0), 4, false, Magic.OBJECT_TELEPORT);
				break;
			case OPTION_3:
				Magic.sendTeleportSpell(player, 654, 331, 2931, 2933, 0, 0d, new WorldTile(3180, 3045, 0), 4, false, Magic.OBJECT_TELEPORT);
				break;
			case OPTION_4:
				Magic.sendTeleportSpell(player, 654, 331, 2931, 2933, 0, 0d, new WorldTile(3349, 3003, 0), 4, false, Magic.OBJECT_TELEPORT);
				break;
			case OPTION_5:
				Magic.sendTeleportSpell(player, 654, 331, 2931, 2933, 0, 0d, new WorldTile(3401, 2916, 0), 4, false, Magic.OBJECT_TELEPORT);
				break;
			}
		default:
			end();
	...
	private void sendTravelOptions() {
		stage = 18;
		sendOptionsDialogue("Where do you wish to travel?", "I want to travel to Shantay Pass, ", "I want to travel to Uzer.", "I want to travel to the Bedabin Camp.", "I want to travel to north Pollnivneach.","I want to travel to Nardah.");
	}
