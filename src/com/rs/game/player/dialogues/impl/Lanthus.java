...
public class Lanthus extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			sendOptionsDialogue(DEFAULT_OPTIONS_TITLE, "What is this place?", "What do you have for trade?", "How many Castle Wars games have I finished?", "Can you imbue my items?");
			stage = 0;
		} else if (stage == 0) {
			if (componentId == OPTION_1) {
				...
				sendNPCDialogue(npcId, NORMAL, "Use items on me to imbue them in exchange for castle war tickets.");
				stage = -1;
			} else {
				end();
			}
