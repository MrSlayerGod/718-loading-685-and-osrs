...
public class AncientEffigiesD extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			...
			int xp = (int) (AncientEffigies.getExp(itemId) * (player.isExpert() || player.isHCIronman() || player.isUltimateIronman() || player.isIronman() ? 1 : player.isNormal() ? 3 : Settings.XP_RATE));
