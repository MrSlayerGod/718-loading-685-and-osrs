...
public class BootDwarf extends Dialogue {
	...
	public void start() {
		...
		{ NPCConfig.forID(npcId).name, "'Hello tall person." }, IS_NPC, npcId, 9827);
	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			...
			{ NPCConfig.forID(npcId).name, "I'm called Boot, becasue when I was very young, I used to", "sleep, in a largue boot." }, IS_NPC, npcId, 9827);
		} else if (stage == 2) {
			stage = -2;
