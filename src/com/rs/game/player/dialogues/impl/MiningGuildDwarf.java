...
public final class MiningGuildDwarf extends Dialogue {
	...
	public void start() {
		...
		{ NPCConfig.forID(npcId).name, "Welcome to the Mining Guild.", "Can I help you with anything?" }, IS_NPC, npcId, 9827);
	...
	public void run(int interfaceId, int componentId) {
		...
		case 3:
			stage = 6;
			sendEntityDialogue(SEND_2_TEXT_CHAT, new String[]
			{ NPCConfig.forID(npcId).name, "Sorry, but rules are rules. Do some more training first.", "Can I help you with anything else?" }, IS_NPC, npcId, 9827);
			break;
		case 4:
			stage = 5;
			sendEntityDialogue(SEND_1_TEXT_CHAT, new String[]
		...
		case 5:
			stage = 6;
			sendEntityDialogue(SEND_1_TEXT_CHAT, new String[]
			{ NPCConfig.forID(npcId).name, "Yes, that's amazing! Did you want anything else?" }, IS_NPC, npcId, 9827);
		...
		case 8:
			...
			{ NPCConfig.forID(npcId).name, "What do you think? We smelt it into bars, smith the metal", "to make armour and weapons, then we exchange them for", "goods and services." }, IS_NPC, npcId, 9827);
			break;
		case 9:
			stage = 10;
			sendEntityDialogue(SEND_2_TEXT_CHAT, new String[]
		...
		case 11:
			stage = 12;
			sendEntityDialogue(SEND_3_TEXT_CHAT, new String[]
			{ NPCConfig.forID(npcId).name, "so much easier. There are plenty of dwarven traders", "working in Keldagrim. Anyway, can I help you with anything", "else?" }, IS_NPC, npcId, 9827);
			break;
		case 12:
			stage = 13;
		...
		case 15:
			stage = 16;
			sendEntityDialogue(SEND_1_TEXT_CHAT, new String[]
			{ NPCConfig.forID(npcId).name, "can help you with?" }, IS_NPC, npcId, 9827);
			break;
		case 16:
			stage = 17;
		...
		case 17:
			if (componentId == 1) {
				stage = -1;
				sendEntityDialogue(SEND_1_TEXT_CHAT, new String[]
				{ NPCConfig.forID(npcId).name, "So what can I help you with, then?" }, IS_NPC, npcId, 9827);
			} else {
				stage = 18;
				sendEntityDialogue(SEND_1_TEXT_CHAT, new String[]
		...
		case 18:
			stage = -2;
			sendEntityDialogue(SEND_1_TEXT_CHAT, new String[]
			{ NPCConfig.forID(npcId).name, "Okay, bye then." }, IS_NPC, npcId, 9827);
			break;
		default:
			end();
			break;
