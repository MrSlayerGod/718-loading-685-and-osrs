...
public class WizardFinix extends Dialogue {
	...
	public void start() {
		...
		{ "Wizard", "Hello. How can I help you?", }, IS_NPC, npc.getId(), 9843);
		stage = 1;
	}
	...
	public void run(int interfaceId, int componentId) {
		...
		case 2:
			...
			case OPTION_1:
				sendEntityDialogue(SEND_1_TEXT_CHAT, new String[]
				{ "Wizard", "I'm " + "Wizard" + ". I am a student of runecrafting.", }, IS_NPC, npc.getId(), 9843);
				stage = 3;
				break;
			case OPTION_5:
				sendEntityDialogue(SEND_1_TEXT_CHAT, new String[]
				{ "Wizard", "Sure" }, IS_NPC, npc.getId(), 9764);
				stage = 22;
				break;
			default:
				end();
		...
		case 3:
			...
			{ player.getDisplayName(), "Ah, pleased to meet you, " + "Wizard" + ". I'm " + player.getDisplayName() + ".", "What are you doing here?" }, IS_PLAYER, -1, 9827);
			stage = 4;
			break;
		case 4:
			sendEntityDialogue(SEND_2_TEXT_CHAT, new String[]
			{ "Wizard", "I'm creating runes by siphoning energy out of the", "Runespan." }, IS_NPC, npc.getId(), 9843);
			stage = 5;
			break;
		case 5:
			sendEntityDialogue(SEND_1_TEXT_CHAT, new String[]
		...
		case 6:
			sendEntityDialogue(SEND_2_TEXT_CHAT, new String[]
			{ "Wizard", "Yes, it's a new way to make runes. I discovered it,", "actually!" }, IS_NPC, npc.getId(), 9843);
			stage = 7;
			break;
		case 7:
		...
		case 8:
			...
			case 11:
				...
				{ "Wizard", "That is another one of my discoveries! Runecrafting", "altars will not last forever. One day, the altars will run", "out!" }, IS_NPC, npc.getId(), 9843);
				stage = 9;
				break;
			case 13:
		...
		case 12:
			sendEntityDialogue(SEND_2_TEXT_CHAT, new String[]
			{ "Wizard", "Exactly. That is why learning to siphon energy from the", "world around us is important." }, IS_NPC, npc.getId(), 9772);
			stage = 13;
			break;
		case 13:
			sendEntityDialogue(SEND_2_TEXT_CHAT, new String[]
		...
		case 17:
			sendEntityDialogue(SEND_1_TEXT_CHAT, new String[]
			{ "Wizard", "runic energy in the Runespan for years." }, IS_NPC, npc.getId(), 9843);
			stage = 18;
			break;
		case 18:
			sendEntityDialogue(SEND_1_TEXT_CHAT, new String[]
		...
		case 19:
			sendEntityDialogue(SEND_1_TEXT_CHAT, new String[]
			{ "Wizard", "... we are outside the Runecrafting Guild - yes!" }, IS_NPC, npc.getId(), 9843);
			stage = 20;
			break;
		case 20:
