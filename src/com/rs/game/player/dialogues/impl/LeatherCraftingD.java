...
public class LeatherCraftingD extends Dialogue {
	...
	{ 35, 70 }, //hard
	{ 62, 126, 124, 186, 248, 124 }, //green
	{ 70, 140, 140, 210, 280, 140 },
	{ 78, 156, 156, 234, 312, 156 },
	{ 86, 172,  172, 258, 334, 172 },
	{ 94, 188, 188, 282 },
	{ 100, 300, 1000 },
	{ 10, 20, 30 },
	{ 50, 150, 500 },
	...
	{
	{ new Item(6326, 5), new Item(6328, 6), new Item(6330, 8), new Item(6324, 12), new Item(6322, 15), new Item(52272, 2) },
	{ new Item(1059, 1), new Item(1061, 1), new Item(1167, 1), new Item(1063, 1), new Item(1129, 1), new Item(1095, 1), new Item(1169, 1) },
	{ new Item(1131, 1), new Item(52269, 2) },
	{ new Item(1065, 1), new Item(1099, 2), new Item(12936, 2), new Item(1135, 3), new Item(52275, 2)}, //green
	{ new Item(2487, 1), new Item(2493, 2), new Item(12943, 2), new Item(2499, 3),  new Item(52278, 2)},
	{ new Item(2489, 1), new Item(2495, 2), new Item(12950, 2), new Item(2501, 3),  new Item(52281, 2)},
	{ new Item(2491, 1), new Item(2497, 2), new Item(12957, 2), new Item(2503, 3),  new Item(52284, 2)},
	...
	{ new Item(43385, 3), new Item(43389, 4), new Item(43387, 5)},
	};
	private static final Item[][] REQUIRED_BASE_ITEMS =
	{ {null, null, null, null, null, new Item(52254)}
	, null
	, {null, new Item(52251)}
	,  {null, null, null, null, new Item(52257)}
	, {null, null, null, null, new Item(52260)}
	, {null, null, null, null, new Item(52263)}
	, {null, null, null, null, new Item(52266)}
	, null
			, new Item[]
	{ new Item(22452, 1), new Item(22454, 1), new Item(22456, 1) }, new Item[]
	{ new Item(22452, 1), new Item(22454, 1), new Item(22456, 1) }, new Item[]
	{ new Item(22452, 1), new Item(22454, 1), new Item(22456, 1) }
	, null
	, null
	...
	public void run(int interfaceId, int componentId) {
		...
		player.getActionManager().setAction(new Action() {
			...
			public boolean checkAll(Player player) {
				...
				if (extraItems != null && extraItems[componentIndex] != null) {
			...
			public int processWithDelay(Player player) {
				...
				player.setNextAnimation(new Animation(player.getInventory().containsOneItem(14113, 14105) ? 11064 : dungeoneering ? 13247 : 1249));
				return 3;
			}
	...
	public static boolean isExtraItem(int requestedId) {
		for (int index = 0; index < REQUIRED_BASE_ITEMS.length; index++) {
			...
			if (items == null)
				continue;
			for (Item item : items) {
				if (item != null && item.getId() == requestedId)
					return true;
			}
		}
		return false;
