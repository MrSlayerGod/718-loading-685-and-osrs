...
public class ClanInvite extends Dialogue {
	...
	public void start() {
		...
		if (player.getInterfaceManager().containsScreenInter() || player.getControlerManager().getControler() != null && player.getControlerManager().getControler() instanceof StealingCreationLobbyController) {
			end();
			return;
		}
