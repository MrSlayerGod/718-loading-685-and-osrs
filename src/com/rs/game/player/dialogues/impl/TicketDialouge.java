...
public class TicketDialouge extends Dialogue {
	...
	@Override
	public void start() {
		sendDialogue("Welcome to the Ticket Control Centre, please select your inquiry. Please be warned, abuse of this system will result in a ban or jail. These punishments cannot be appealed.");
	}
