...
public abstract class Controller {
	...
	public static boolean check(Player player, Class clazz) {
		return player.getControlerManager().getControler() != null && clazz.isInstance(player.getControlerManager().getControler());
	}
