...
public class Trivia {
    ...
    public static final String[][] QUESTIONS = new String[][]{
            ...
            {"How many skills do we have on Gallifrey?", "25"},
           ...
           // {"How many spins do you get per day if you are a Diamond Donator?", "5"},
            ...
            {"How many Quest bossfights do we offer on Gallifrey?", "6"},
            {"How many Donator Ranks do we have on Gallifrey?", "6"},
            {"How many waves are there in the Inferno?", "69"},
            {"What revision of RSPS does Gallifrey fall under?", "718"},
            ...
            {"What is the name of the new World Boss on Gallifrey?", "callus"},
           ...
           // {"What is the new best-in-slot magic weapon on Matrix?", "cataclysm"},
            ...
            {"What platform can you join to stay up-to-date with Gallifrey news, market, media, etc?", "discord"},
            ...
            {"Who is the Owner and Developer of Gallifrey?", "dragonkk"},
            ...
            {"What is the best-in-slot ring on Gallifrey?", "infinity ring"},
            {"What boss drops the Trident of the Seas?", "kraken"},
            {"What is the highest level Slayer Master available on Gallifrey?", "kuradal"},
           ...
           // {"Who is the designer of the Callus boss?", "nick"},
            {"What is the name of the website for our forums?", "Gallifrey.io"},
          ...
          //  {"What is the name of Nick and Zio's unique PvM events?", "the horde"},
            ...
            {"What command opens up the Gallifrey Teleport Interface?", "tp"},
            ...
            {"What is the top Donator Rank on Gallifrey?", "vip"},
