...
public class InterfaceReplacer {
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException {
		int interfaceId = 271;//C:/Users/andre/Documents/GitHub/avalon/Avalon - Server/data/cache
		CacheLibrary cache1 = new CacheLibrary("data/cache/");
		CacheLibrary cache2 = new CacheLibrary("D:\\servers\\Decay-718-Github\\Decay-Server-Build\\data\\cache\\");
