...
public class ItemWeights {
	...
	private final static String PACKED_PATH = "data/item/packedWeights.dat";
	private final static String UNPACKED_PATH = "data/item/unpackedWeights.txt";
	...
	public static final double getWeight(Item item, boolean equiped) {
		...
		if(weight == null)
			return item.getDefinitions().isWearItem() ? 3 : 0.5;
		if(equiped) {
