...
public class MusicHints {
	...
	private final static String PACKED_PATH = "data/music/packedMusicHints.mh";
	private final static String UNPACKED_PATH = "data/music/unpackedMusicHints.txt";
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			BufferedWriter out = new BufferedWriter(new FileWriter("new.txt"));
			while (true) {
				...
				int musicIndex = (int) ClientScriptMap.getMap(1351).getKeyForValue(musicId);
				String hint = splitedLine[1];
				out.write(musicIndex +" - "+hint);
				out.newLine();
			}
			in.close();
			out.flush();
