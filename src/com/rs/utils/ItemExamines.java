...
public class ItemExamines {
	...
	private final static String PACKED_PATH = "data/item/packedExamines.e";
	private final static String UNPACKED_PATH = "data/item/unpackedExamines.txt";
	...
	public static final String getExamine(Item item) {
		...
		if (item.getDefinitions().isNoted())
			return "Swap this note at any bank for a "+item.getName()+".";
