...
public final class NPCCombatDefinitionsL {
	...
	public final static NPCCombatDefinitions DEFAULT_DEFINITION = new NPCCombatDefinitions(1, -1, -1, -1, 5, 1, 33, 0, NPCCombatDefinitions.MELEE, -1, -1, NPCCombatDefinitions.PASSIVE, 2);
	private static final String PACKED_PATH = "data/npc/packedCombatDefinitions.ncd";
	...
	private static void loadUnpackedNPCCombatDefinitions() {
		...
		//	DataOutputStream out = new DataOutputStream(new FileOutputStream(PACKED_PATH));
			BufferedReader in = new BufferedReader(new FileReader("data/npc/combatDefinitions.txt"));
			while (true) {
